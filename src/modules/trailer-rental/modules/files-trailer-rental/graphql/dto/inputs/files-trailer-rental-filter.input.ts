...
@ObjectType()
export class FilesTrailerRentalFilter implements IEntityFilter<FilesTrailerRentalEntity>{
...
export const FilesTrailerRentalFilterInput = FilterType(FilesTrailerRentalFilter);